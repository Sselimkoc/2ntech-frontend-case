...
function EmptyState() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-12 md:p-20 text-center ">
      ...
      <h3 className="text-xl font-medium text-text-main mb-2">Burası biraz boş görünüyor.</h3>
      <p className="text-base text-text-muted max-w-sm">Bu kullanıcı henüz bir şey paylaşmamış. Takipte kalarak yeni gönderilerden haberdar olabilirsiniz.</p>
    </div>
  );
}